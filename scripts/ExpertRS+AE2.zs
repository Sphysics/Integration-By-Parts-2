...
recipes.addShapeless(<appliedenergistics2:controller>,[<refinedstorage:controller>]);// ME CONTROLLER
recipes.addShapeless(<appliedenergistics2:part:380>,[<refinedstorage:grid>]);//ME TERMINAL
recipes.addShapeless(<appliedenergistics2:drive>,[<refinedstorage:disk_drive>]);//ME DRIVE
//------------------------------------------------------------------------------------------------------------